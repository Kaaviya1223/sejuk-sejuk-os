    ...
    <div className="overflow-hidden rounded-xl border border-slate-line bg-white">
      ...
      <div className="flex items-center gap-3 border-b border-slate-line bg-frost/60 px-3.5 py-2.5">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="flex flex-wrap items-center gap-x-2 gap-y-0.5">
            ...
            <span className="rounded-full bg-marine-100 px-2 py-0.5 text-[10px] font-medium uppercase tracking-wide text-marine-600">
      ...
      {!compact && (
        <div className="px-3.5 py-3">
          <p className="whitespace-pre-line rounded-xl rounded-tl-sm bg-[#E8F7EF] px-3 py-2.5 text-[13px] leading-relaxed text-marine">
